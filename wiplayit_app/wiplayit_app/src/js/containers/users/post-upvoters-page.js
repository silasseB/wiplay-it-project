...
class PostUpVotersBox extends Component {
    ...
    componentDidMount() {
        ...
        let usersById = `postUpVoters${id}`;
        let apiUrl    = api.getPostUpVotersListApi(id);
...
export default withHigherOrderIndexBox(PostUpVotersBox);
