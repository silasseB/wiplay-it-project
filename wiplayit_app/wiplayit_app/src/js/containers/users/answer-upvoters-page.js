...
class AnswerUpVotersBox extends Component {
    ...
    componentDidMount() {
        ...
        let usersById = `answerUpVoters${id}`;
        let apiUrl    = api.getAnswerUpVotersListApi(id);
...
export default withHigherOrderIndexBox(AnswerUpVotersBox);
