...
class PostReplyUpVotersBox extends Component {
    ...
    componentDidMount() {
        ...
        let  usersById = `postReplyUpVoters${id}`;
        let  apiUrl    = api.getPostReplyUpVotersListApi(id)
...
export default withHigherOrderIndexBox(PostReplyUpVotersBox);
