...
class AnswerCommentUpVotersBox extends Component {
    ...
    componentDidMount() {
        ...
        let usersById  = `answerCommentUpVoters${id}`;
        let apiUrl     = api.getAnswerCommentUpVotersListApi(id)
...
export default withHigherOrderIndexBox(AnswerCommentUpVotersBox);
