...
class AnswerReplyUpVotersBox extends Component {
    ...
    componentDidMount() {
        ...
        let usersById  = `answerReplyUpVoters${id}`;
        let apiUrl     = api.getAnswerReplyUpVotersListApi(id)
...
export default withHigherOrderIndexBox(AnswerReplyUpVotersBox);
