...
urlpatterns = [
        ...
        path("api/create/question/", CreateQuestionView.as_view({'get':'get','post':'post' }), name="question_create"),
        path("api/create/post/",    CreatePostView.as_view({'get':'get','post':'post' }), name="post_create"),
        
        path("api/create/question/<int:pk>/answer/", CreateAnswerView.as_view({'get':'get','post':'post' })),
